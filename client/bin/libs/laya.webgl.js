(function(window, document, Laya) {
  ...
  var AtlasResourceManager = (function() {
    ...
    __proto.pushData = function(texture) {
      ...
      if (nWebGLImageIndex != -1) {
        ...
        this._setAtlasParam = false;
        var bFound = false;
        var nImageGridX = Math.ceil(
          (texture.bitmap.width + 2) / this._gridSize
        );
        var nImageGridY = Math.ceil(
          (texture.bitmap.height + 2) / this._gridSize
        );
        var bSuccess = false;
        for (var k = 0; k < 2; k++) {
          ...
          for (i = 0; i < maxAtlaserCount; i++) {
            ...
            this._atlaserArray.length - 1 >= altasIndex ||
    ...
    __getset(1, AtlasResourceManager, 'instance', function() {
      if (!AtlasResourceManager._Instance) {
        AtlasResourceManager._Instance = new AtlasResourceManager(
          laya.webgl.atlas.AtlasResourceManager.atlasTextureWidth,
          laya.webgl.atlas.AtlasResourceManager.atlasTextureHeight,
          /*CLASS CONST:laya.webgl.atlas.AtlasResourceManager.gridSize*/ 16,
  ...
  var BlendMode = (function() {
    ...
    BlendMode.BlendNormal = function(gl) {
      gl.blendFunc(
        /*laya.webgl.WebGLContext.ONE*/ 1,
        /*laya.webgl.WebGLContext.ONE_MINUS_SRC_ALPHA*/ 0x0303
      );
    };
    ...
    BlendMode.BlendAdd = function(gl) {
      gl.blendFunc(
        /*laya.webgl.WebGLContext.ONE*/ 1,
        /*laya.webgl.WebGLContext.DST_ALPHA*/ 0x0304
      );
    };

    BlendMode.BlendMultiply = function(gl) {
      gl.blendFunc(
        /*laya.webgl.WebGLContext.DST_COLOR*/ 0x0306,
        /*laya.webgl.WebGLContext.ONE_MINUS_SRC_ALPHA*/ 0x0303
      );
    };
    ...
    BlendMode.BlendOverlay = function(gl) {
      gl.blendFunc(
        /*laya.webgl.WebGLContext.ONE*/ 1,
        /*laya.webgl.WebGLContext.ONE_MINUS_SRC_COLOR*/ 0x0301
      );
    };
    ...
    BlendMode.BlendMask = function(gl) {
      gl.blendFunc(
        /*laya.webgl.WebGLContext.ZERO*/ 0,
        /*laya.webgl.WebGLContext.SRC_ALPHA*/ 0x0302
      );
    };
  ...
  var Path = (function() {
    function Path() {
      ...
      this.ib = IndexBuffer2D.create(
        /*laya.webgl.WebGLContext.DYNAMIC_DRAW*/ 0x88e8
      );
    ...
    __proto.polygon = function(x, y, points, color, borderWidth, borderColor) {
      var geo;
      this.geomatrys.push(
        (this._curGeomatry = geo = new Polygon(
          x,
          y,
          points,
          color,
    ...
    __proto.drawLine = function(x, y, points, width, color) {
      ...
      if (this.closePath) {
        this.geomatrys.push(
          (this._curGeomatry = geo = new LoopLine(x, y, points, width, color))
        );
      } else {
        this.geomatrys.push(
          (this._curGeomatry = geo = new Line(x, y, points, width, color))
        );
      }
      geo.fill = false;
      return geo;
  ...
  var SaveBase = (function() {
    ...
    __proto.restore = function(context) {
      ...
      this._newSubmit &&
        ((context._curSubmit = Submit.RENDERBASE), (context._renderKey = 0));
    };
  ...
  var SaveClipRect = (function() {
    ...
    __proto.restore = function(context) {
      ...
      this._submitScissor.submitLength =
        context._submits._length - this._submitScissor.submitIndex;
    ...
    SaveClipRect.save = function(context, submitScissor) {
      if (
        (context._saveMark._saveuse &
          /*laya.webgl.canvas.save.SaveBase.TYPE_CLIPRECT*/ 0x20000) ==
        /*laya.webgl.canvas.save.SaveBase.TYPE_CLIPRECT*/ 0x20000
      )
        return;
  ...
  var SaveClipRectStencil = (function() {
    ...
    SaveClipRectStencil.save = function(
      context,
      submitStencil,
      x,
      y,
      ...
      if (
        (context._saveMark._saveuse &
          /*laya.webgl.canvas.save.SaveBase.TYPE_CLIPRECT_STENCIL*/ 0x40000) ==
        /*laya.webgl.canvas.save.SaveBase.TYPE_CLIPRECT_STENCIL*/ 0x40000
      )
        return;
      ...
      var o =
        cache._length > 0 ? cache[--cache._length] : new SaveClipRectStencil();
      o._clipSaveRect = context._clipRect;
  ...
  var SaveTransform = (function() {
    ...
    SaveTransform.save = function(context) {
      ...
      if (
        (_saveMark._saveuse &
          /*laya.webgl.canvas.save.SaveBase.TYPE_TRANSFORM*/ 0x800) ===
        /*laya.webgl.canvas.save.SaveBase.TYPE_TRANSFORM*/ 0x800
      )
        return;
  ...
  var RenderTargetMAX = (function() {
    ...
    __proto.size = function(w, h) {
      ...
      this._width = w;
      this._height = h;
      if (!this.target) this.target = RenderTarget2D.create(w, h);
      else this.target.size(w, h);
      if (
        !this.target.hasListener(/*laya.events.Event.RECOVERED*/ 'recovered')
      ) {
        this.target.on(
          /*laya.events.Event.RECOVERED*/ 'recovered',
          this,
          function(e) {
    ...
    __proto._flushToTarget = function(context, target) {
      ...
      WebGL.mainContext.disable(
        /*laya.webgl.WebGLContext.SCISSOR_TEST*/ 0x0c11
      );
      ...
      target.start();
      Config.showCanvasMark
        ? target.clear(0, 1, 0, 0.3)
      ...
      if (worldScissorTest) {
        var y =
          RenderState2D.height - preworldClipRect.y - preworldClipRect.height;
        WebGL.mainContext.scissor(
          preworldClipRect.x,
          y,
          preworldClipRect.width,
          preworldClipRect.height
        );
        WebGL.mainContext.enable(
          /*laya.webgl.WebGLContext.SCISSOR_TEST*/ 0x0c11
        );
      }
  ...
  var Shader2D = (function() {
    ...
    Shader2D.__init__ = function() {
      ...
      Shader.preCompile2D(
        0,
        /*laya.webgl.shader.d2.ShaderDefines2D.TEXTURE2D*/ 0x01,
        vs,
        ps,
        null
      );
      ...
      Shader.preCompile2D(
        0,
        /*laya.webgl.shader.d2.ShaderDefines2D.COLOR2D*/ 0x02,
        vs,
        ps,
        null
      );
      ...
      Shader.preCompile2D(
        0,
        /*laya.webgl.shader.d2.ShaderDefines2D.PRIMITIVE*/ 0x04,
        vs,
        ps,
        null
      );
      ...
      Shader.preCompile2D(
        0,
        /*laya.webgl.shader.d2.ShaderDefines2D.FILLTEXTURE*/ 0x100,
        vs,
        ps,
        null
      );
      ...
      Shader.preCompile2D(
        0,
        /*laya.webgl.shader.d2.ShaderDefines2D.SKINMESH*/ 0x200,
        vs,
        ps,
        null
      );
  ...
  var ShaderDefines = (function() {
    ...
    __proto.toNameDic = function() {
      ...
      return r
        ? r
        : ShaderDefines._toText(this._value, this._int2name, this._int2nameMap);
    };
  ...
  var SkinMesh = (function() {
    ...
    __proto.render = function(context, x, y) {
      if (Render.isWebGL && this.mTexture) {
        ...
        var tempSubmit = Submit.createShape(
          context,
          this.mIBBuffer,
          this.mVBBuffer,
          this.mEleNum,
  ...
  var SkinMeshBuffer = (function() {
    ...
    SkinMeshBuffer.getInstance = function() {
      return (SkinMeshBuffer.instance =
        SkinMeshBuffer.instance || new SkinMeshBuffer());
    };
  ...
  var BasePoly = (function() {
    ...
    __proto.sector = function(outVert, outIndex, start) {
      ...
      for (var i = 0; i < edges + 1; i++) {
        outVert.push(
          x + Math.sin(seg * i + this.r0) * w,
          y + Math.cos(seg * i + this.r0) * h
        );
        outVert.push(r, g, b);
      }
      for (i = 0; i < edges; i++) {
    ...
    //闭合路径
    __proto.createLoopLine = function(
      p,
      indices,
      lineWidth,
      len,
  ...
  var Earcut = (function() {
    ...
    Earcut.filterPoints = function(start, end) {
      ...
      do {
        ...
        if (
          !p.steiner &&
          (Earcut.equals(p, p.next) || Earcut.area(p.prev, p, p.next) === 0)
        ) {
          Earcut.removeNode(p);
          p = end = p.prev;
          if (p === p.next) break;
    ...
    Earcut.earcutLinked = function(
      ...
      while (ear.prev !== ear.next) {
        ...
        if (
          invSize
            ? Earcut.isEarHashed(ear, minX, minY, invSize)
            : Earcut.isEar(ear)
        ) {
    ...
    Earcut.cureLocalIntersections = function(start, triangles, dim) {
      ...
      do {
        ...
        if (
          !Earcut.equals(a, b) &&
          Earcut.intersects(a, p, p.next, b) &&
          Earcut.locallyInside(a, b) &&
          Earcut.locallyInside(b, a)
        ) {
    ...
    Earcut.isValidDiagonal = function(a, b) {
      return (
        a.next.i !== b.i &&
        a.prev.i !== b.i &&
        !Earcut.intersectsPolygon(a, b) &&
        Earcut.locallyInside(a, b) &&
        Earcut.locallyInside(b, a) &&
        Earcut.middleInside(a, b)
      );
    };
    ...
    Earcut.intersects = function(p1, q1, p2, q2) {
      if (
        (Earcut.equals(p1, q1) && Earcut.equals(p2, q2)) ||
        (Earcut.equals(p1, q2) && Earcut.equals(p2, q1))
      )
        return true;
      return (
        Earcut.area(p1, q1, p2) > 0 !== Earcut.area(p1, q1, q2) > 0 &&
  ...
  var Vertex = (function() {
    function Vertex(p) {
      //this.points=null;
      if (p instanceof Float32Array) this.points = p;
  ...
  var Submit = (function() {
    ...
    __proto.renderSubmit = function() {
      ...
      gl.drawElements(
        /*laya.webgl.WebGLContext.TRIANGLES*/ 0x0004,
        this._numEle,
        /*laya.webgl.WebGLContext.UNSIGNED_SHORT*/ 0x1403,
        this._startIdx
      );
      return 1;
    };
    ...
    Submit.createSubmit = function(context, ib, vb, pos, sv) {
      var o = Submit._cache._length
        ? Submit._cache[--Submit._cache._length]
        : new Submit();
      if (vb == null) {
      ...
      o._blendFn = context._targets
        ? BlendMode.targetFns[blendType]
        : BlendMode.fns[blendType];
      o.shaderValue = sv;
    ...
    Submit._cache =
      ((Submit._cache = []), (Submit._cache._length = 0), Submit._cache);
    return Submit;
  })();
  ...
  var SubmitCMD = (function() {
    ...
    SubmitCMD.create = function(args, fun) {
      var o = SubmitCMD._cache._length
        ? SubmitCMD._cache[--SubmitCMD._cache._length]
        : new SubmitCMD();
      o.fun = fun;
      o.args = args;
      return o;
  ...
  var SubmitOtherIBVB = (function() {
    ...
    SubmitOtherIBVB.create = function(
      context,
      vb,
      ib,
      numElement,
      ...
      type === void 0 && (type = 0);
      var o = !SubmitOtherIBVB._cache._length
        ? new SubmitOtherIBVB()
        : SubmitOtherIBVB._cache[--SubmitOtherIBVB._cache._length];
      o._ib = ib;
      o._vb = vb;
      ...
      switch (type) {
        case 0:
          o.offset = 0;
          o.startIndex =
            (offset / (CONST3D2D.BYTES_PE * vb.vertexStride)) * 1.5;
    ...
    SubmitOtherIBVB._cache =
      ((SubmitOtherIBVB._cache = []),
      (SubmitOtherIBVB._cache._length = 0),
      SubmitOtherIBVB._cache);
  ...
  var SubmitScissor = (function() {
    ...
    SubmitScissor.create = function(context) {
      var o = SubmitScissor._cache._length
        ? SubmitScissor._cache[--SubmitScissor._cache._length]
        : new SubmitScissor();
      o.context = context;
      return o;
    };

    SubmitScissor._cache =
      ((SubmitScissor._cache = []),
      (SubmitScissor._cache._length = 0),
      SubmitScissor._cache);
  ...
  var SubmitStencil = (function() {
    ...
    __proto.do1 = function() {
      ...
      gl.stencilFunc(
        /*laya.webgl.WebGLContext.EQUAL*/ 0x0202,
        this.level,
        0xff
      );
      gl.stencilOp(
        /*laya.webgl.WebGLContext.KEEP*/ 0x1e00,
        /*laya.webgl.WebGLContext.KEEP*/ 0x1e00,
        /*laya.webgl.WebGLContext.INCR*/ 0x1e02
      );
    };
    ...
    __proto.do7 = function() {
      ...
      gl.stencilOp(
        /*laya.webgl.WebGLContext.KEEP*/ 0x1e00,
        /*laya.webgl.WebGLContext.KEEP*/ 0x1e00,
        /*laya.webgl.WebGLContext.DECR*/ 0x1e03
      );
    };
    ...
    SubmitStencil.restore = function(context, clip, m, _x, _y) {
      ...
      if (SubmitStencil._mask == 0) {
        ...
        if (
          ...
          var submit = (context._curSubmit = Submit.createSubmit(
            context,
            context._ib,
            vb,
            ((vb._byteLength -
              /*laya.webgl.canvas.WebGLContext2D._RECTVBSIZE*/ 16 *
                /*laya.webgl.utils.Buffer2D.FLOAT32*/ 4) /
              32) *
              3,
            Value2D.create(
              /*laya.webgl.shader.d2.ShaderDefines2D.COLOR2D*/ 0x02,
    ...
    SubmitStencil.create = function(step) {
      var o = SubmitStencil._cache._length
        ? SubmitStencil._cache[--SubmitStencil._cache._length]
        : new SubmitStencil();
      o.step = step;
    ...
    SubmitStencil._cache =
      ((SubmitStencil._cache = []),
      (SubmitStencil._cache._length = 0),
      SubmitStencil._cache);
  ...
  var SubmitTarget = (function() {
    ...
    __proto.renderSubmit = function() {
      ...
      if (target) {
        ...
        Stat.drawCall++;
        Stat.trianglesFaces += this._numEle / 3;
        WebGL.mainContext.drawElements(
          /*laya.webgl.WebGLContext.TRIANGLES*/ 0x0004,
          this._numEle,
          /*laya.webgl.WebGLContext.UNSIGNED_SHORT*/ 0x1403,
          this._startIdx
    ...
    SubmitTarget.create = function(context, ib, vb, pos, sv, proName) {
      var o = SubmitTarget._cache._length
        ? SubmitTarget._cache[--SubmitTarget._cache._length]
        : new SubmitTarget();
      o._ib = ib;
      o._vb = vb;
      o.proName = proName;
  ...
  var CharSegment = (function() {
    ...
    __proto.textToSpit = function(str) {
      this._words = splitter.splitGraphemes(str);
    };
    ...
    __proto.getCharCode = function(i) {
      return splitter.codePointAt(this._words[i], 0);
    };
  ...
  var DrawText = (function() {
    ...
    DrawText._drawSlow = function(
      ...
      var drawValue = DrawText._drawValue.value(
        font,
        fillColor,
        borderColor,
        lineWidth,
      ...
      if (words) {
        ...
        for (i = 0, n = words.length; i < n; i++) {
          ...
          chars[i] = oneChar =
            DrawText._charsCache[id] ||
            DrawText.getChar(htmlWord.char, id, drawValue);
          oneChar.active();
        }
      } else {
        ...
        if (Text.CharacterCache) {
          ...
          for (i = 0, n = len; i < n; i++) {
            ...
            chars[i] = oneChar =
              DrawText._charsCache[id] ||
              DrawText.getChar(DrawText._charSeg.getChar(i), id, drawValue);
            oneChar.active();
            width += oneChar.cw;
          }
        } else {
      ...
      if (words) {
        for (i = 0, n = chars.length; i < n; i++) {
          ...
          if (!oneChar.isSpace) {
            ...
            ctx._drawText(
              texture,
              x + dx + htmlWord.x * sx - bdSz,
              y + htmlWord.y * sy - bdSz,
              texture.width,
              texture.height,
              curMat,
              0,
        ...
        for (i = 0, n = chars.length; i < n; i++) {
          ...
          if (!oneChar.isSpace) {
            ...
            save &&
              ((value = save[saveLength++]),
              value || (value = save[saveLength - 1] = []),
              (value[0] = texture),
              (value[1] = dx - bdSz),
              (value[2] = -bdSz));
          }
      ...
      if (words) {
        ...
        if (Text.CharacterCache) {
          if (cache) {
            ...
            DrawText._textCachesPool[DrawText._curPoolIndex]
              ? ((cache = DrawText._textsCache[id] =
                  DrawText._textCachesPool[DrawText._curPoolIndex]),
                (cache.length = 0))
  ...
  var GlUtils = (function() {
    ...
    GlUtils.fillIBQuadrangle = function(buffer, count) {
      if (count > 65535 / 4) {
        throw Error(
          'IBQuadrangle count:' + count + ' must<:' + Math.floor(65535 / 4)
        );
        return false;
      }
      count = Math.floor(count);
      buffer._resizeBuffer(
        (count + 1) * 6 * /*laya.webgl.utils.Buffer2D.SHORT*/ 2,
        false
      );
    ...
    GlUtils.expandIBQuadrangle = function(buffer, count) {
      buffer.bufferLength >=
        count * 6 * /*laya.webgl.utils.Buffer2D.SHORT*/ 2 ||
        GlUtils.fillIBQuadrangle(buffer, count);
    };
    ...
    GlUtils.fillTranglesVB = function(vb, x, y, points, m, _x, _y) {
      ...
      for (var i = 0; i < len; i += 4) {
        ...
        if (a !== 1 || b !== 0 || c !== 0 || d !== 1) {
          ...
          vbdata[vpos + i + 1] =
            (points[i] + x) * b + (points[i + 1] + y) * d + ty;
        } else {
          m.bTransform = false;
          x += m.tx + _x;
          y += m.ty + _y;
    ...
    GlUtils.copyPreImgVb = function(vb, dx, dy) {
      ...
      vb.byteLength =
        (vpos + /*laya.webgl.canvas.WebGLContext2D._RECTVBSIZE*/ 16) << 2;
      var vbdata = vb.getFloat32Array();
    ...
    GlUtils.fillRectImgVb = function(
      vb,
      clip,
      x,
      y,
      ...
      var useClip =
        clip &&
        clip.width < /*laya.webgl.canvas.WebGLContext2D._MAXSIZE*/ 99999999;
      if (a !== 1 || b !== 0 || c !== 0 || d !== 1) {
        m.bTransform = true;
        if (b === 0 && c === 0) {
          mType = 23;
  ...
  var ShaderCompile = (function() {
    ...
    __proto._compileToTree = function(
      parent,
      lines,
      start,
      includefiles,
              ...
              if (!node.noCompile) {
                ...
                console.log(
                  'function():Boolean{return ' +
                    text.substr(ofs + node.name.length) +
                    '}'
                );
              }
    ...
    __proto.createShader = function(define, shaderName, createShader) {
      ...
      return (createShader || Shader.create)(
        defineStr + vs.join('\n'),
        defineStr + ps.join('\n'),
        shaderName,
        this._nameMap
    ...
    ShaderCompile._parseOne = function(
      attributes,
      uniforms,
      words,
      i,
                ...
                if (word != 'attribute' && word != 'uniform') {
                  if (word == '#else') {
                    for (i++; i < n; i++) {
                      ...
                      i = ShaderCompile._parseOne(
                        attributes,
                        uniforms,
                        words,
                        i,
                        word,
                        !definesName[tempelse]
                      );
                    }
                  }
                  continue;
    ...
    ShaderCompile._reg = new RegExp(
      '(".*")|(\'.*\')|([#\\w\\*-\\.+/()=<>{}\\\\]+)|([,;:\\\\])',
      'g'
    );
    ShaderCompile._splitToWordExps = new RegExp(
      '[(".*")]+|[(\'.*\')]+|([ \\t=\\+\\-*/&%!<>!%(),;])',
      'g'
    );
      ...
      ShaderNode = (function() {
        ...
        __proto._toscript = function(def, out, id) {
          ...
          if (this.condition) {
            ...
            this.conditionType ===
              /*laya.webgl.utils.ShaderCompile.IFDEF_ELSE*/ 2 &&
              (ifdef = !ifdef);
            if (!ifdef) return out;
          }
          this.text && out.push(this.text);
          this.childs.length > 0 &&
            this.childs.forEach(function(o, index, arr) {
      ...
      InlcudeFile = (function() {
        function InlcudeFile(txt) {
          ...
          while (true) {
            ...
            ofs = txt.indexOf('\n', begin);
            var words = ShaderCompile.splitToWords(
  ...
  var WebGL = (function() {
    ...
    WebGL._uint16ArraySlice = function(__arg) {
      ...
      if (arg.length === 0) {
        ...
        if (end > start) {
          sz = end - start;
          dec = new Uint16Array(sz);
          for (i = start; i < end; i++) dec[i - start] = _this[i];
        } else {
    ...
    WebGL.enable = function() {
      ...
      RunDriver.createFilterAction = action
        ? action
        : function(type) {
            return new ColorFilterActionGL();
          };
      RunDriver.clear = function(color) {
        RenderState2D.worldScissorTest &&
          laya.webgl.WebGL.mainContext.disable(
            /*laya.webgl.WebGLContext.SCISSOR_TEST*/ 0x0c11
          );
        var ctx = Render.context.ctx;
        var c =
          ctx._submits._length == 0 || Config.preserveDrawingBuffer
            ? Color.create(color)._color
            : Stage._wgColor;
      ...
      RunDriver.addToAtlas = function(texture, force) {
        ...
        if (
          Laya.__typeof(bitmap, 'laya.webgl.resource.IMergeAtlasBitmap') &&
          bitmap.allowMerageInAtlas
        ) {
          bitmap.on(
            /*laya.events.Event.RECOVERED*/ 'recovered',
            texture,
            texture.addTextureToAtlas
          );
        }
      };
      ...
      RunDriver.beginFlush = function() {
        ...
        for (var i = 0; i < count; i++) {
          ...
          atlerCanvas._flashCacheImageNeedFlush &&
            RunDriver.flashFlushImage(atlerCanvas);
        }
      };
      RunDriver.drawToCanvas = function(
        sprite,
        _renderType,
        canvasWidth,
        canvasHeight,
        ...
        offsetX |= 0;
        offsetY |= 0;
        var renderTarget = RenderTarget2D.create(
          canvasWidth,
          canvasHeight,
          /*laya.webgl.WebGLContext.RGBA*/ 0x1908,
          /*laya.webgl.WebGLContext.UNSIGNED_BYTE*/ 0x1401,
          0,
          false
        );
        renderTarget.start();
        ...
        RenderSprite.renders[_renderType]._fun(
          ...
          Render.context,
          offsetX,
          RenderState2D.height - canvasHeight + offsetY
        );
      ...
      RunDriver.addTextureToAtlas = function(texture) {
        ...
        texture.bitmap.enableMerageInAtlas &&
          AtlasResourceManager.instance.addToAtlas(texture);
      };
      ...
      Filter._EndTarget = function(scope, context) {
        ...
        if (b) {
          RenderState2D.worldScissorTest = true;
          laya.webgl.WebGL.mainContext.enable(
            /*laya.webgl.WebGLContext.SCISSOR_TEST*/ 0x0c11
          );
          context.ctx.save();
          var tClipRect = scope.getValue('clipRect');
          context.ctx.clipRect(
            tClipRect.x,
            tClipRect.y,
            tClipRect.width,
            tClipRect.height
      ...
      Filter._filter = function(sprite, context, x, y) {
        ...
        if (next) {
          ...
          if (
            len == 1 &&
            filters[0].type == /*laya.filters.Filter.COLOR*/ 0x20
          ) {
            context.ctx.save();
          ...
          if (!out || sprite._repaint) {
            ...
            var submit = SubmitCMD.create(
              [scope, sprite, context, 0, 0],
              Filter._filterStart
            );
            ...
            for (var i = 0; i < len; i++) {
              if (i != 0) {
                ...
                context.addRenderObject(submit);
                shaderValue = Value2D.create(
                  /*laya.webgl.shader.d2.ShaderDefines2D.TEXTURE2D*/ 0x01,
                  0
                );
                Matrix.TEMP.identity();
                context.ctx.drawTarget(
                  scope,
                  0,
                  0,
                  b.width,
            ...
            tIsHaveGlowFilter = sprite._$P._isHaveGlowFilter
              ? sprite._$P._isHaveGlowFilter
              : false;
            if (tIsHaveGlowFilter) {
              tPadding = 50;
              tHalfPadding = 25;
      ...
      Float32Array.prototype.slice ||
        (Float32Array.prototype.slice = WebGL._float32ArraySlice);
      Uint16Array.prototype.slice ||
        (Uint16Array.prototype.slice = WebGL._uint16ArraySlice);
      Uint8Array.prototype.slice ||
        (Uint8Array.prototype.slice = WebGL._uint8ArraySlice);
      return true;
    };
    ...
    WebGL.onInvalidGLRes = function() {
      ...
      WebGL.mainContext.viewport(
        0,
        0,
        RenderState2D.width,
        RenderState2D.height
      );
    ...
    WebGL.init = function(canvas, width, height) {
      ...
      if (gl.getShaderPrecisionFormat != null) {
        var vertexPrecisionFormat = gl.getShaderPrecisionFormat(
          /*laya.webgl.WebGLContext.VERTEX_SHADER*/ 0x8b31,
          /*laya.webgl.WebGLContext.HIGH_FLOAT*/ 0x8df2
        );
        var framePrecisionFormat = gl.getShaderPrecisionFormat(
          /*laya.webgl.WebGLContext.FRAGMENT_SHADER*/ 0x8b30,
          /*laya.webgl.WebGLContext.HIGH_FLOAT*/ 0x8df2
        );
        WebGL.shaderHighPrecision =
          vertexPrecisionFormat.precision && framePrecisionFormat.precision
            ? true
            : false;
      } else {
      ...
      WebGL.compressS3tc_srgb = gl.getExtension(
  ...
  var WebGLContext = (function() {
    ...
    WebGLContext.setDepthTest = function(gl, value) {
      value !== WebGLContext._depthTest &&
        ...
        value
          ? gl.enable(/*CLASS CONST:laya.webgl.WebGLContext.DEPTH_TEST*/ 0x0b71)
          : gl.disable(
              /*CLASS CONST:laya.webgl.WebGLContext.DEPTH_TEST*/ 0x0b71
            ));
    };
    ...
    WebGLContext.setBlend = function(gl, value) {
      value !== WebGLContext._blend &&
        ...
        value
          ? gl.enable(/*CLASS CONST:laya.webgl.WebGLContext.BLEND*/ 0x0be2)
          : gl.disable(/*CLASS CONST:laya.webgl.WebGLContext.BLEND*/ 0x0be2));
    };
    ...
    WebGLContext.setCullFace = function(gl, value) {
      value !== WebGLContext._cullFace &&
        ...
        value
          ? gl.enable(/*CLASS CONST:laya.webgl.WebGLContext.CULL_FACE*/ 0x0b44)
          : gl.disable(
              /*CLASS CONST:laya.webgl.WebGLContext.CULL_FACE*/ 0x0b44
            ));
    };
  ...
  var GraphicsGL = (function(_super) {
    ...
    __proto.setIBVB = function(x, y, ib, vb, numElement, shader) {
      this._saveToCmd(Render.context._setIBVB, [
        x,
        y,
        ib,
        vb,
  ...
  var WebGLContext2D = (function(_super) {
    ...
    __proto._fillText = function(
      ...
      if (AtlasResourceManager.enabled) {
        ...
        DrawText.drawText(
          ...
          this._curMat,
          font,
          textAlign || this._other.textAlign,
          color,
          strokeColor,
          lineWidth,
          x,
        ...
        if (
          ...
          colorAdd !== shader.colorAdd ||
          curShader.colorAdd !== shader.colorAdd
        ) {
          shader.glTexture = null;
    ...
    __proto.fillBorderWords = function(
      words,
      x,
      y,
      font,
    ...
    __proto.fillBorderText = function(
      txt,
      x,
      y,
      fontStr,
    ...
    __proto._fillBorderText = function(
      txt,
      words,
      x,
      y,
      ...
      if (shader.ALPHA !== curShader.ALPHA) shader.glTexture = null;
      var font = fontStr
        ? (WebGLContext2D._fontTemp.setFont(fontStr), WebGLContext2D._fontTemp)
        : this._other.font;
      DrawText.drawText(
        this,
        txt,
    ...
    __proto.fillRect = function(x, y, width, height, fillStyle) {
      ...
      if (
        ...
        var curShader = this._curSubmit.shaderValue;
        if (
          shader.fillStyle !== curShader.fillStyle ||
          shader.ALPHA !== curShader.ALPHA
        ) {
          shader.glTexture = null;
          var submit = (this._curSubmit = Submit.createSubmit(
            this,
            this._ib,
            vb,
            ((vb._byteLength - 16 * /*laya.webgl.utils.Buffer2D.FLOAT32*/ 4) /
              32) *
              3,
            Value2D.create(
              /*laya.webgl.shader.d2.ShaderDefines2D.COLOR2D*/ 0x02,
    ...
    __proto.fillTexture = function(
      ...
      if (
        ...
        this._renderKey = 0;
        var submit = SubmitTexture.create(
          this,
          this._ib,
          vb,
          ((vb._byteLength - 16 * /*laya.webgl.utils.Buffer2D.FLOAT32*/ 4) /
        ...
        if (AtlasResourceManager.enabled && !this._isMain)
          submit.addTexture(
            texture,
            (vb._byteLength >> 2) -
              /*CLASS CONST:laya.webgl.canvas.WebGLContext2D._RECTVBSIZE*/ 16
          );
    ...
    __proto.setShader = function(shader) {
      SaveBase.save(
        this,
        /*laya.webgl.canvas.save.SaveBase.TYPE_SHADER*/ 0x100000,
        this._shader2D,
        true
      );
    ...
    __proto.setFilters = function(value) {
      SaveBase.save(
        this,
        /*laya.webgl.canvas.save.SaveBase.TYPE_FILTERS*/ 0x200000,
        this._shader2D,
        true
      );
    ...
    __proto.willDrawTexture = function(tex, alpha) {
      ...
      var rid =
        ...
        /*laya.webgl.submit.Submit.TYPE_TEXTURE*/ 10016;
      ...
      submit._preIsSameTextureShader =
        this._curSubmit._renderType ===
          /*laya.webgl.submit.Submit.TYPE_TEXTURE*/ 10016 &&
        shader.ALPHA === curShader.ALPHA;
      this._curSubmit = submit;
    ...
    __proto._drawTextureM = function(
      tex,
      x,
      y,
      width,
      ...
      if (
        ...
        if (AtlasResourceManager.enabled && !this._isMain)
          this._curSubmit.addTexture(
            tex,
            (finalVB._byteLength >> 2) -
              /*CLASS CONST:laya.webgl.canvas.WebGLContext2D._RECTVBSIZE*/ 16
          );
        this._curSubmit._numEle += 6;
        this._maxNumEle = Math.max(this._maxNumEle, this._curSubmit._numEle);
    ...
    __proto.drawTextureWithTransform = function(
      tex,
      x,
      y,
      width,
      ...
      var prey = this._y;
      (tx !== 0 || ty !== 0) &&
        ((this._x = tx * curMat.a + ty * curMat.c),
        (this._y = ty * curMat.d + tx * curMat.b));
    ...
    __proto.fillQuadrangle = function(tex, x, y, point4, m) {
      ...
      if (tex.bitmap) {
        ...
        if (shader.glTexture != t_tex || shader.ALPHA !== curShader.ALPHA) {
          ...
          submit = this._curSubmit = Submit.createSubmit(
            this,
            this._ib,
            vb,
            (vb._byteLength / 32) * 3,
        ...
        if (
          !submit.shaderValue.fillStyle ||
          !submit.shaderValue.fillStyle.equal(tex) ||
          shader.ALPHA !== curShader.ALPHA
        ) {
          shader.glTexture = null;
          submit = this._curSubmit = Submit.createSubmit(
          ...
          submit.shaderValue.defines.add(
            /*laya.webgl.shader.d2.ShaderDefines2D.COLOR2D*/ 0x02
          );
    ...
    __proto.drawCanvas = function(canvas, x, y, width, height) {
      ...
      this._renderKey = 0;
      if (src._targets) {
        this._submits[this._submits._length++] = SubmitCanvas.create(
          src,
          0,
          null
        );
    ...
    __proto.drawTarget = function(
      ...
      if (
        ...
        shader.glTexture = null;
        var curShader = this._curSubmit.shaderValue;
        var submit = (this._curSubmit = SubmitTarget.create(
          this,
          this._ib,
          vb,
          ((vb._byteLength - 16 * /*laya.webgl.utils.Buffer2D.FLOAT32*/ 4) /
    ...
    __proto.drawTriangles = function(
      tex,
      x,
      y,
      vertices,
      ...
      this._renderKey = -1;
      var submit = (this._curSubmit = SubmitTexture.create(
        this,
    ...
    __proto.transform = function(a, b, c, d, tx, ty) {
      SaveTransform.save(this);
      Matrix.mul(
        Matrix.TEMP.setTo(a, b, c, d, tx, ty),
        this._curMat,
        this._curMat
      );
    ...
    __proto.clipRect = function(x, y, width, height) {
      if (this._curMat.b != 0 || this._curMat.c != 0) {
        ...
        var minx = Math.min(
          Math.min(
            Math.min(vbdata[nPos + 0], vbdata[nPos + 4]),
            vbdata[nPos + 8]
          ),
          vbdata[nPos + 12]
        );
        var maxx = Math.max(
          Math.max(
            Math.max(vbdata[nPos + 0], vbdata[nPos + 4]),
            vbdata[nPos + 8]
          ),
          vbdata[nPos + 12]
        );
        var miny = Math.min(
          Math.min(
            Math.min(vbdata[nPos + 1], vbdata[nPos + 5]),
            vbdata[nPos + 9]
          ),
          vbdata[nPos + 13]
        );
        var maxy = Math.max(
          Math.max(
            Math.max(vbdata[nPos + 1], vbdata[nPos + 5]),
            vbdata[nPos + 9]
          ),
          vbdata[nPos + 13]
        );
        SaveClipRectStencil.save(
          this,
          submitStencil1,
          x,
          y,
    ...
    __proto.setIBVB = function(
      ...
      if (ib === null) {
        if (!Render.isFlash) {
          ...
          var falshVB = vb;
          falshVB._selfIB ||
            (falshVB._selfIB = IndexBuffer2D.create(
              /*laya.webgl.WebGLContext.STATIC_DRAW*/ 0x88e4
            ));
          falshVB._selfIB.clear();
          ib = falshVB._selfIB;
        }
        GlUtils.expandIBQuadrangle(
          ib,
          vb._byteLength /
            /*laya.webgl.utils.Buffer2D.FLOAT32*/ (4 * vb.vertexStride * 4)
        );
      }
      if (!shaderValues || !shader)
        throw Error('setIBVB must input:shader shaderValues');
      var submit = SubmitOtherIBVB.create(
        this,
        vb,
        ib,
        numElement,
    ...
    __proto.flush = function() {
      var maxNum =
        Math.max(
          this._vb._byteLength / /*laya.webgl.utils.Buffer2D.FLOAT32*/ (4 * 16),
          this._maxNumEle / 6
        ) + 8;
      if (
        maxNum >
        this._ib.bufferLength / (6 * /*laya.webgl.utils.Buffer2D.SHORT*/ 2)
      ) {
        GlUtils.expandIBQuadrangle(this._ib, maxNum);
      }
      if (
        !this._isMain &&
        AtlasResourceManager.enabled &&
        AtlasResourceManager._atlasRestore > this._atlasResourceChange
      ) {
      ...
      if (this.lineWidth > 0) {
        if (this.mId == -1) {
          ...
          if (this.mHaveLineKey) {
            var tShapeLine = VectorGraphManager.getInstance().shapeLineDic[
              this.mId
            ];
            tShapeLine.rebuild(tPath.tempArray);
            tPath.setGeomtry(tShapeLine);
          } else {
            VectorGraphManager.getInstance().addLine(
              this.mId,
              tPath.drawLine(
                0,
                0,
    ...
    __proto.line = function(fromX, fromY, toX, toY, lineWidth, mat) {
      ...
      if (
        ...
        var curShader = submit.shaderValue;
        if (
          shader.strokeStyle !== curShader.strokeStyle ||
          shader.ALPHA !== curShader.ALPHA
        ) {
          shader.glTexture = null;
          submit = this._curSubmit = Submit.createSubmit(
    ...
    __proto.arcTo = function(x1, y1, x2, y2, r) {
      ...
      WebGLContext2D._tempPoint.setTo(
        tPath.getEndPointX(),
        tPath.getEndPointY()
      );
    ...
    __proto.quadraticCurveTo = function(cpx, cpy, x, y) {
      ...
      var tArray = tBezier.getBezierPoints(
        [this._path.getEndPointX(), this._path.getEndPointY(), cpx, cpy, x, y],
        30,
        2
      );
    ...
    __proto.drawPoly = function(
      ...
      if (lineWidth > 0) {
        if (this.mHaveLineKey) {
          ...
          VectorGraphManager.getInstance().addShape(
            this.mId,
            tPath.drawLine(x, y, points, lineWidth, boderColor)
          );
        }
        tPath.update();
        tempSubmit = Submit.createShape(
    ...
    __getset(
      ...
      function(value) {
        ...
        n == null ||
          ...
          (SaveBase.save(
            this,
            /*laya.webgl.canvas.save.SaveBase.TYPE_GLOBALCOMPOSITEOPERATION*/ 0x10000,
            this,
            true
          ),
          (this._curSubmit = Submit.RENDERBASE),
    ...
    __getset(
      ...
      function(value) {
        this._shader2D.strokeStyle.equal(value) ||
          (SaveBase.save(
            this,
            /*laya.webgl.canvas.save.SaveBase.TYPE_STROKESTYLE*/ 0x200,
            this._shader2D,
            false
          ),
    ...
    __getset(
      ...
      function(value) {
        ...
        if (value != this._shader2D.ALPHA) {
          SaveBase.save(
            this,
            /*laya.webgl.canvas.save.SaveBase.TYPE_ALPHA*/ 0x1,
            this._shader2D,
            true
          );
    ...
    __getset(
      ...
      function(value) {
        this._shader2D.fillStyle.equal(value) ||
          (SaveBase.save(
            this,
            /*laya.webgl.canvas.save.SaveBase.TYPE_FILESTYLE*/ 0x2,
            this._shader2D,
            false
          ),
    ...
    __getset(
      ...
      function(value) {
        this._other.textAlign === value ||
          ...
          SaveBase.save(
            this,
            /*laya.webgl.canvas.save.SaveBase.TYPE_TEXTALIGN*/ 0x8000,
            this._other,
            false
          ),
          (this._other.textAlign = value));
    ...
    __getset(
      ...
      function(value) {
        this._other.lineWidth === value ||
          ...
          SaveBase.save(
            this,
            /*laya.webgl.canvas.save.SaveBase.TYPE_LINEWIDTH*/ 0x100,
            this._other,
            false
          ),
          (this._other.lineWidth = value));
    ...
    __getset(
      ...
      function(value) {
        this._other.textBaseline === value ||
          ...
          SaveBase.save(
            this,
            /*laya.webgl.canvas.save.SaveBase.TYPE_TEXTBASELINE*/ 0x4000,
            this._other,
            false
          ),
          (this._other.textBaseline = value));
    ...
    __getset(0, __proto, 'font', null, function(str) {
      ...
      SaveBase.save(
        this,
        /*laya.webgl.canvas.save.SaveBase.TYPE_FONT*/ 0x8,
        this._other,
        false
      );
      this._other.font === FontInContext.EMPTY
        ? (this._other.font = new FontInContext(str))
  ...
  var Value2D = (function(_super) {
    ...
    __proto._withWorldShaderDefines = function() {
      ...
      var sd =
        Shader.sharders[this.mainID | this.defines._value | defs.getValue()];
      if (!sd) {
        var def = {};
        var dic;
        var name;
        dic = this.defines.toNameDic();
        for (name in dic) def[name] = '';
        dic = defs.toNameDic();
        for (name in dic) def[name] = '';
        sd = Shader.withCompile2D(
          0,
          this.mainID,
          def,
          this.mainID | this.defines._value | defs.getValue(),
          Shader2X.create
        );
      }
    ...
    __proto.upload = function() {
      ...
      if (RenderState2D.worldMatrix4 !== RenderState2D.TEMPMAT4_ARRAY)
        this.defines.add(
          /*laya.webgl.shader.d2.ShaderDefines2D.WORLDMAT*/ 0x80
        );
      WebGL.shaderHighPrecision &&
        this.defines.add(
          /*laya.webgl.shader.d2.ShaderDefines2D.SHADERDEFINE_FSHIGHPRECISION*/ 0x400
        );
      var sd = renderstate2d.worldShaderDefines
        ? this._withWorldShaderDefines()
        : Shader.sharders[this.mainID | this.defines._value] ||
    ...
    Value2D.__init__ = function() {
      Value2D._POSITION = [
        2,
        /*laya.webgl.WebGLContext.FLOAT*/ 0x1406,
        false,
        4 * CONST3D2D.BYTES_PE,
        0,
      ];
      Value2D._TEXCOORD = [
        2,
      ...
      Value2D._initone(
        /*laya.webgl.shader.d2.ShaderDefines2D.TEXTURE2D*/ 0x01 |
          /*laya.webgl.shader.d2.ShaderDefines2D.COLORADD*/ 0x40,
        TextSV
      );
      Value2D._initone(
        /*laya.webgl.shader.d2.ShaderDefines2D.TEXTURE2D*/ 0x01 |
          /*laya.webgl.shader.d2.ShaderDefines2D.FILTERGLOW*/ 0x08,
        TextureSV
      );
    };
    ...
    Value2D.create = function(mainType, subType) {
      ...
      if (types._length) return types[--types._length];
      else return new Value2D._typeClass[mainType | subType](subType);
    };
    ...
    __proto._mask = function(sprite, context, x, y) {
      ...
      if (mask) {
        ...
        if (tRect.width > 0 && tRect.height > 0) {
          ...
          context.ctx.save();
          context.clipRect(
            x - tf.translateX + tRect.x,
            y - tf.translateY + tRect.y,
            tRect.width,
            tRect.height
          );
          next._fun.call(next, sprite, context, x, y);
          ...
          context.addRenderObject(submitStencil);
          Matrix.TEMP.identity();
          var shaderValue = Value2D.create(
            /*laya.webgl.shader.d2.ShaderDefines2D.TEXTURE2D*/ 0x01,
            0
          );
          ...
          context.ctx.drawTarget(
            scope,
            x + tRect.x - tf.translateX,
            y + tRect.y - tf.translateY,
            w,
            h,
            Matrix.TEMP,
            'tmpTarget',
  ...
  var Atlaser = (function(_super) {
    ...
    __proto.computeUVinAtlasTexture = function(
      texture,
      oriUV,
      offsetX,
      offsetY
    ...
    __proto.addToAtlasTexture = function(mergeAtlasBitmap, offsetX, offsetY) {
      if (mergeAtlasBitmap instanceof laya.webgl.resource.WebGLImage) {
        ...
        var sUrl = webImage.url;
        this._InAtlasWebGLImagesKey[sUrl ? sUrl : webImage.id] = {
          bitmap: mergeAtlasBitmap,
          offsetInfoID: this._InAtlasWebGLImagesOffsetValue.length,
        };
        this._InAtlasWebGLImagesOffsetValue.push([offsetX, offsetY]);
      }
      this._atlasCanvas.texSubImage2D(
        offsetX,
        offsetY,
        /*__JS__ */ mergeAtlasBitmap.atlasImgData ||
          mergeAtlasBitmap.atlasSource
      );
  ...
  var Line = (function(_super) {
    ...
    __proto.rebuild = function(points) {
      ...
      for (var i = 0; i < tLen; i++) {
        ...
        tCurrY = points[i * 2 + 1];
        if (
          Math.abs(tLastX - tCurrX) > 0.01 ||
          Math.abs(tLastY - tCurrY) > 0.01
        ) {
  ...
  var SubmitCanvas = (function(_super) {
    function SubmitCanvas() {
      ...
      SubmitCanvas.__super.call(
        this,
        /*laya.webgl.submit.Submit.TYPE_2D*/ 10000
      );
    ...
    SubmitCanvas.create = function(ctx_src, alpha, filters) {
      var o = !SubmitCanvas._cache._length
        ? new SubmitCanvas()
        : SubmitCanvas._cache[--SubmitCanvas._cache._length];
      o._ctx_src = ctx_src;
      var v = o.shaderValue;
      v.alpha = alpha;
  ...
  var SubmitTexture = (function(_super) {
    ...
    __proto.renderSubmit = function() {
      ...
      Stat.trianglesFaces += this._numEle / 3;
      if (
        this._preIsSameTextureShader &&
        BaseShader.activeShader &&
        SubmitTexture._shaderSet
      )
        ...
        for (var i = 0, s = this._texs.length; i < s; i++) {
          ...
          if (tex2.bitmap !== webGLImg || i + 1 === s) {
            ...
            gl.drawElements(
              ...
              (i - index + 1) * 6,
              /*laya.webgl.WebGLContext.UNSIGNED_SHORT*/ 0x1403,
              this._startIdx + index * 6 * CONST3D2D.BYTES_PIDX
            );
    ...
    SubmitTexture.create = function(context, ib, vb, pos, sv) {
      var o = SubmitTexture._cache._length
        ? SubmitTexture._cache[--SubmitTexture._cache._length]
        : new SubmitTexture();
      if (vb == null) {
        vb = o._selfVb || (o._selfVb = VertexBuffer2D.create(-1));
        vb.clear();
    ...
    SubmitTexture._cache =
      ((SubmitTexture._cache = []),
      (SubmitTexture._cache._length = 0),
      SubmitTexture._cache);
    SubmitTexture._shaderSet = true;
  ...
  var MeshTexture = (function(_super) {
    function MeshTexture() {
      MeshTexture.__super.call(
        this,
        laya.webgl.utils.MeshTexture.const_stride,
        0,
        0
      );
      this.canReuse = true;
  ...
  var RenderTarget2D = (function(_super) {
    function RenderTarget2D(
      ...
      this._magFifter = 0;
      this._destroy = false;
      surfaceFormat === void 0 &&
        (surfaceFormat = /*laya.webgl.WebGLContext.RGBA*/ 0x1908);
      surfaceType === void 0 &&
        (surfaceType = /*laya.webgl.WebGLContext.UNSIGNED_BYTE*/ 0x1401);
      depthStencilFormat === void 0 &&
        (depthStencilFormat = /*laya.webgl.WebGLContext.DEPTH_STENCIL*/ 0x84f9);
      ...
      if (
        ...
        this._depthStencilFormat ===
          /*laya.webgl.WebGLContext.DEPTH_STENCIL*/ 0x84f9
      ) {
    ...
    __proto.start = function() {
      ...
      gl.bindFramebuffer(
        /*laya.webgl.WebGLContext.FRAMEBUFFER*/ 0x8d40,
        this.bitmap.frameBuffer
      );
      this._alreadyResolved = false;
      if (this._type == 1) {
    ...
    __proto.end = function() {
      ...
      gl.bindFramebuffer(
        /*laya.webgl.WebGLContext.FRAMEBUFFER*/ 0x8d40,
        this._preRenderTarget ? this._preRenderTarget.bitmap.frameBuffer : null
      );
    ...
    __proto.getData = function(x, y, width, height) {
      ...
      var canRead =
        gl.checkFramebufferStatus(
          /*laya.webgl.WebGLContext.FRAMEBUFFER*/ 0x8d40
        ) === /*laya.webgl.WebGLContext.FRAMEBUFFER_COMPLETE*/ 0x8cd5;
      if (!canRead) {
        gl.bindFramebuffer(
          /*laya.webgl.WebGLContext.FRAMEBUFFER*/ 0x8d40,
          null
    ...
    __proto._createWebGLRenderTarget = function() {
      this.bitmap = new WebGLRenderTarget(
        this.width,
        this.height,
        this._surfaceFormat,
        this._surfaceType,
    ...
    RenderTarget2D.create = function(
      w,
      h,
      surfaceFormat,
      surfaceType,
    ...
    __proto._bind = function() {
      ...
      if (Buffer._bindActive[this._bufferType] !== this._glBuffer) {
        this._bufferType === /*laya.webgl.WebGLContext.ARRAY_BUFFER*/ 0x8892 &&
          (Buffer._bindVertexBuffer = this._glBuffer);
        Buffer._gl.bindBuffer(
          this._bufferType,
          (Buffer._bindActive[this._bufferType] = this._glBuffer)
        );
        BaseShader.activeShader = null;
      }
    };
  ...
  var AtlasWebGLCanvas = (function(_super) {
    ...
    __proto.recreateResource = function() {
      ...
      WebGLContext.bindTexture(
        gl,
        /*laya.webgl.WebGLContext.TEXTURE_2D*/ 0x0de1,
        glTex
      );
      gl.texImage2D(
        /*laya.webgl.WebGLContext.TEXTURE_2D*/ 0x0de1,
      ...
      gl.texParameteri(
        /*laya.webgl.WebGLContext.TEXTURE_2D*/ 0x0de1,
        /*laya.webgl.WebGLContext.TEXTURE_MIN_FILTER*/ 0x2801,
        /*laya.webgl.WebGLContext.LINEAR*/ 0x2601
      );
      gl.texParameteri(
        /*laya.webgl.WebGLContext.TEXTURE_2D*/ 0x0de1,
        /*laya.webgl.WebGLContext.TEXTURE_MAG_FILTER*/ 0x2800,
        /*laya.webgl.WebGLContext.LINEAR*/ 0x2601
      );
      gl.texParameteri(
        /*laya.webgl.WebGLContext.TEXTURE_2D*/ 0x0de1,
        /*laya.webgl.WebGLContext.TEXTURE_WRAP_S*/ 0x2802,
        /*laya.webgl.WebGLContext.CLAMP_TO_EDGE*/ 0x812f
      );
      gl.texParameteri(
        /*laya.webgl.WebGLContext.TEXTURE_2D*/ 0x0de1,
        /*laya.webgl.WebGLContext.TEXTURE_WRAP_T*/ 0x2803,
        /*laya.webgl.WebGLContext.CLAMP_TO_EDGE*/ 0x812f
      );
      preTarget &&
        preTexture &&
        WebGLContext.bindTexture(gl, preTarget, preTexture);
    ...
    __proto.texSubImage2D = function(xoffset, yoffset, bitmap) {
      if (!Render.isFlash) {
        ...
        if (Render.isConchWebGL) {
          ...
          gl.pixelStorei(
            /*laya.webgl.WebGLContext.UNPACK_PREMULTIPLY_ALPHA_WEBGL*/ 0x9241,
            true
          );
          xoffset - 1 >= 0 &&
            gl.texSubImage2D(
        ...
        this._flashCacheImageNeedFlush ||
          (this._flashCacheImageNeedFlush = true);
      }
    };
     ...
     *@param value 图片宽度
     */
    __getset(0, __proto, 'width', _super.prototype._$get_width, function(
      value
    ) {
      this._w = value;
    });
     ...
     *@param value 图片高度
     */
    __getset(0, __proto, 'height', _super.prototype._$get_height, function(
      value
    ) {
      this._h = value;
    });
  ...
  var WebGLCanvas = (function(_super) {
    ...
    __proto.getContext = function(contextID, other) {
      return this._ctx
        ? this._ctx
        : (this._ctx = WebGLCanvas._createContext(this));
    };
    ...
    __proto.createWebGlTexture = function() {
      ...
      gl.pixelStorei(
        /*laya.webgl.WebGLContext.UNPACK_FLIP_Y_WEBGL*/ 0x9240,
        this.flipY ? 1 : 0
      );
      if (Render.isConchWebGL) {
        gl.texImage2DEx(
          WebGLCanvas.premulAlpha,
          /*laya.webgl.WebGLContext.TEXTURE_2D*/ 0x0de1,
          0,
          /*laya.webgl.WebGLContext.RGBA*/ 0x1908,
          /*laya.webgl.WebGLContext.RGBA*/ 0x1908,
  ...
  var WebGLCharImage = (function(_super) {
    function WebGLCharImage(content, drawValue) {
      ...
      this.onresize(
        this.cw + Config.CborderSize * 2,
        this.ch + Config.CborderSize * 2
      );
    ...
    __proto.recreateResource = function() {
      ...
      if (bIsConchApp) {
        ...
        if (this.xs != 1 || this.ys != 1) {
          nFontSize = parseInt(
            nFontSize * (this.xs > this.ys ? this.xs : this.ys) + ''
          );
        }
  ...
  var WebGLRenderTarget = (function(_super) {
    ...
    __proto.recreateResource = function() {
      ...
      var repeat = this._repeat
        ? /*laya.webgl.WebGLContext.REPEAT*/ 0x2901
        : /*laya.webgl.WebGLContext.CLAMP_TO_EDGE*/ 0x812f;
      var isPot = Arith.isPOT(this._w, this._h);
      if (isPot) {
        if (this._mipMap)
          minFifter !== -1 ||
            (minFifter = /*laya.webgl.WebGLContext.LINEAR_MIPMAP_LINEAR*/ 0x2703);
        else
          minFifter !== -1 ||
            (minFifter = /*laya.webgl.WebGLContext.LINEAR*/ 0x2601);
        magFifter !== -1 ||
          (magFifter = /*laya.webgl.WebGLContext.LINEAR*/ 0x2601);
        gl.texParameteri(
          /*laya.webgl.WebGLContext.TEXTURE_2D*/ 0x0de1,
          /*laya.webgl.WebGLContext.TEXTURE_MIN_FILTER*/ 0x2801,
          minFifter
      ...
      gl.framebufferTexture2D(
        /*laya.webgl.WebGLContext.FRAMEBUFFER*/ 0x8d40,
        /*laya.webgl.WebGLContext.COLOR_ATTACHMENT0*/ 0x8ce0,
        /*laya.webgl.WebGLContext.TEXTURE_2D*/ 0x0de1,
        this._source,
        0
      );
      if (this._depthStencilFormat) {
        ...
        gl.bindRenderbuffer(
          /*laya.webgl.WebGLContext.RENDERBUFFER*/ 0x8d41,
          this._depthStencilBuffer
        );
        ...
        switch (this._depthStencilFormat) {
          case /*laya.webgl.WebGLContext.DEPTH_COMPONENT16*/ 0x81a5:
            gl.framebufferRenderbuffer(
              /*laya.webgl.WebGLContext.FRAMEBUFFER*/ 0x8d40,
              /*laya.webgl.WebGLContext.DEPTH_ATTACHMENT*/ 0x8d00,
              /*laya.webgl.WebGLContext.RENDERBUFFER*/ 0x8d41,
              this._depthStencilBuffer
            );
            break;
          case /*laya.webgl.WebGLContext.STENCIL_INDEX8*/ 0x8d48:
            gl.framebufferRenderbuffer(
              /*laya.webgl.WebGLContext.FRAMEBUFFER*/ 0x8d40,
              /*laya.webgl.WebGLContext.STENCIL_ATTACHMENT*/ 0x8d20,
              /*laya.webgl.WebGLContext.RENDERBUFFER*/ 0x8d41,
              this._depthStencilBuffer
            );
            break;
          case /*laya.webgl.WebGLContext.DEPTH_STENCIL*/ 0x84f9:
            gl.framebufferRenderbuffer(
              /*laya.webgl.WebGLContext.FRAMEBUFFER*/ 0x8d40,
              /*laya.webgl.WebGLContext.DEPTH_STENCIL_ATTACHMENT*/ 0x821a,
              /*laya.webgl.WebGLContext.RENDERBUFFER*/ 0x8d41,
              this._depthStencilBuffer
            );
            break;
  ...
  var WebGLSubImage = (function(_super) {
    function WebGLSubImage(
      ...
      this._enableMerageInAtlas = true;
      AtlasResourceManager.enabled &&
      this._w < AtlasResourceManager.atlasLimitWidth &&
        this._h < AtlasResourceManager.atlasLimitHeight
        ? (this._allowMerageInAtlas = true)
        : (this._allowMerageInAtlas = false);
    }
    ...
    __proto.disposeResource = function() {
      if (
        !(AtlasResourceManager.enabled && this._allowMerageInAtlas) &&
        this._source
      ) {
        WebGL.mainContext.deleteTexture(this._source);
        this._source = null;
  ...
  var Shader = (function(_super) {
    ...
    __proto._compile = function() {
      ...
      this._vshader = Shader._createShader(
        gl,
        text[0],
        /*laya.webgl.WebGLContext.VERTEX_SHADER*/ 0x8b31
      );
      this._pshader = Shader._createShader(
        gl,
        text[1],
        /*laya.webgl.WebGLContext.FRAGMENT_SHADER*/ 0x8b30
      );
      ...
      if (
        ...
        !gl.getProgramParameter(
          this._program,
          /*laya.webgl.WebGLContext.LINK_STATUS*/ 0x8b82
        )
      ) {
      ...
      var attribNum = 0;
      if (Render.isConchApp) {
        attribNum = gl.getProgramParameterEx(
          this._vs,
          this._ps,
          '',
          /*laya.webgl.WebGLContext.ACTIVE_ATTRIBUTES*/ 0x8b89
        );
      } else {
        attribNum = gl.getProgramParameter(
          this._program,
          /*laya.webgl.WebGLContext.ACTIVE_ATTRIBUTES*/ 0x8b89
        );
      }
      ...
      var nUniformNum = 0;
      if (Render.isConchApp) {
        nUniformNum = gl.getProgramParameterEx(
          this._vs,
          this._ps,
          '',
          /*laya.webgl.WebGLContext.ACTIVE_UNIFORMS*/ 0x8b86
        );
      } else {
        nUniformNum = gl.getProgramParameter(
          this._program,
          /*laya.webgl.WebGLContext.ACTIVE_UNIFORMS*/ 0x8b86
        );
      }
      ...
      for (i = 0, n = this._params.length; i < n; i++) {
        ...
        one.name = this._nameMap[one.codename]
          ? this._nameMap[one.codename]
          : one.codename;
    ...
    __proto._uniform_samplerCube = function(one, value) {
      ...
      if (uploadedValue[0] == null) {
        ...
        WebGLContext.bindTexture(
          gl,
          /*laya.webgl.WebGLContext.TEXTURE_CUBE_MAP*/ 0x8513,
          value
        );
        this._curActTexIndex++;
        return 1;
    ...
    __proto.uploadArray = function(shaderValue, length, _bufferUsage) {
      ...
      for (var i = length - 2; i >= 0; i -= 2) {
        ...
        if (value != null) {
          _bufferUsage &&
            _bufferUsage[one.name] &&
            _bufferUsage[one.name].bind();
          shaderCall += one.fun.call(this, one, value);
        }
      }
      Stat.shaderCall += shaderCall;
    ...
    Shader._TEXTURES = [
      /*laya.webgl.WebGLContext.TEXTURE0*/ 0x84c0,
      /*laya.webgl.WebGLContext.TEXTURE1*/ 0x84c1,
      /*laya.webgl.WebGLContext.TEXTURE2*/ 0x84c2,
      /*laya.webgl.WebGLContext.TEXTURE3*/ 0x84c3,
      /*laya.webgl.WebGLContext.TEXTURE4*/ 0x84c4,
      /*laya.webgl.WebGLContext.TEXTURE5*/ 0x84c5,
      /*laya.webgl.WebGLContext.TEXTURE6*/ 0x84c6,
      ,
      /*laya.webgl.WebGLContext.TEXTURE7*/ 0x84c7,
      /*laya.webgl.WebGLContext.TEXTURE8*/ 0x84c8,
    ];
    Shader._count = 0;
  ...
  var Buffer2D = (function(_super) {
    ...
    __proto.needSize = function(sz) {
      ...
      if (sz) {
        ...
        needsz <= this._buffer.byteLength ||
          this._resizeBuffer(needsz << 1, true);
    ...
    __getset(0, __proto, 'byteLength', null, function(value) {
      ...
      value <= this._buffer.byteLength ||
        this._resizeBuffer(value * 2 + 256, true);
      this._byteLength = value;
    });

    Buffer2D.__int__ = function(gl) {
      IndexBuffer2D.QuadrangleIB = IndexBuffer2D.create(
        /*laya.webgl.WebGLContext.STATIC_DRAW*/ 0x88e4
      );
  ...
  var IndexBuffer2D = (function(_super) {
    function IndexBuffer2D(bufferUsage) {
      ...
      bufferUsage === void 0 &&
        (bufferUsage = /*laya.webgl.WebGLContext.STATIC_DRAW*/ 0x88e4);
  ...
  var VertexBuffer2D = (function(_super) {
    ...
    VertexBuffer2D.create = function(vertexStride, bufferUsage) {
      bufferUsage === void 0 &&
        (bufferUsage = /*laya.webgl.WebGLContext.DYNAMIC_DRAW*/ 0x88e8);
    ...
    __proto.recreateResource = function() {
      ...
      if (!this._image) {
        ...
        this._image.onload = function() {
          ...
          !(_this._allowMerageInAtlas && _this._enableMerageInAtlas)
            ? _this._createWebGlTexture()
            : ((_$this.memorySize = 0), (_$this._recreateLock = false));
        ...
        !(this._allowMerageInAtlas && this._$5__enableMerageInAtlas)
          ...
          : ((this.memorySize = 0), (this._recreateLock = false));
        this.completeCreate();
      }
    };
