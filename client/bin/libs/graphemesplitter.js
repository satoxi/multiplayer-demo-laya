...
function GraphemeSplitter() {
  ...
  this.codePointAt = function(str, idx) {
    if (idx === undefined) {
      idx = 0;
    }
  ...
  this.nextBreak = function(string, index) {
    ...
    var prev = getGraphemeBreakProperty(this.codePointAt(string, index));
    var mid = [];
    for (var i = index + 1; i < string.length; i++) {
      ...
      var next = getGraphemeBreakProperty(this.codePointAt(string, i));
